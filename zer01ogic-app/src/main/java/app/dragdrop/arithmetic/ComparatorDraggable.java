...
public class ComparatorDraggable extends DraggableNode {

    private final ComparatorGraphic graphic;

    public ComparatorDraggable() {
        this.graphic = new ComparatorGraphic();
